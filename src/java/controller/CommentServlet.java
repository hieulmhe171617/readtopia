...
public class CommentServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        commentDAO.addSubComment(userID, bookID, username, subcomment);
        
        HttpSession session = request.getSession();
        session.setAttribute("useridsubcommented", userID);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        //lay dc cac thong tin de add new comment

        CommentDAO commentdao = new CommentDAO();
        commentdao.addComment(u.getId(), bookID, comment);
        response.sendRedirect("displaybook?id=" + bookID_raw);
    }
